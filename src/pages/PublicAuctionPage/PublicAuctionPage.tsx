            ...
            {activeSection === 'overview' ? (
              ...
              <div className={classes.faqList}>
                <details className={classes.faqItem} open>
                  ...
                  <div className={classes.faqAnswer}>
                    <p>Igra Network is a programmable layer on Kaspa BlockDAG, combining flexibility of Ethereum and Bitcoin-grade security of the proof-of-work.</p>
                    <ul className={classes.guideList}>
                      ...
                      <li><a href="https://x.com/Igra_Labs/status/2037186175673188854" target="_blank" rel="noopener noreferrer" className={classes.whiteLink}>Multiple wallets support</a>, including Ledger and Tangem</li>
                      ...
                      <li>Governed by the <a href="https://igra.network/" target="_blank" rel="noopener noreferrer" className={classes.whiteLink}>Igra Association</a> under Swiss law, <a href="https://governance.igralabs.com/" target="_blank" rel="noopener noreferrer" className={classes.whiteLink}>DAO</a> from the day one.</li>
                    </ul>
                  </div>
                </details>
                <details className={classes.faqItem}>
