...
export const newsItems: NewsItem[] = [
  {
    image: news23Image,
    tag: "Giveaway",
    title: "Igra × Tangem wallet giveaway is live",
  ...
  },
  {
    image: news24Image,
    tag: "Ecosystem",
    title: "New additions to the Igra fleet",
    description: "Three projects join the Igra ecosystem: RKStratum — decentralized, community-run Kaspa mining infrastructure; Kaspagent — the first AI agent marketplace on Kaspa, running on Igra; and LYNX — liquid staking for IGRA.",
    link: "https://x.com/Igra_Labs/status/2082868149385642302",
  ...
  },
  {
    ...
    link: "https://x.com/Igra_Labs/status/2074914350926602684",
  ...
  },
  {
    ...
    link: "https://x.com/Igra_Labs/status/2074492198893105463",
    imagePosition: 'top',
  },
  {
    image: news16Image,
