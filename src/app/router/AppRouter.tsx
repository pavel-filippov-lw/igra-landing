...
import { IgraTokenPage, /* BenefitsPage, BenefitsPage2, */ EcosystemPage, HeroPage, ManifestoPage, PrivacyPage, PublicAuctionPage, TeamPage, TermsPage, VisionPage } from '~/pages'
    ...
    <BrowserRouter>
      <ReactRoutes>
        <Route path="/" element={<Outlet />}>
          ...
          <Route path={Routes.publicAuction} element={<PublicAuctionPage />} />
